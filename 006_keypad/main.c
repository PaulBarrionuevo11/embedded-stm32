 ...
 * @brief          : Keypad exercise
 * 					@pins 0 to 3 representing Rows 1 to 4 (output pin)
 * 					@pins 8 to 11 represents Columns 1 to 4 (input pin).
 * 					Use of internal pull up resistors from microcontroller
 * 					for the Columns
 *
 * 					When nothing is pressed MCU is detecting High
 ******************************************************************************
 *
 ******************************************************************************
 */
...
int main(void)
{
	...
	uint32_t volatile *const pGPIODModeReg  =  (uint32_t*)(0x40020000);
	...
	uint32_t volatile *const pPullupDownReg =  (uint32_t*)(0x40020000 + 0x0C);
